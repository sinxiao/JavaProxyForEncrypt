...
import com.jxust.svsh.entity.Artists;

/**
 * Home object for domain model class Artists.
 * @see com.jxust.svsh.dao.Artists
...
public class ArtistsHome {
	...
	public Artists findById(java.lang.Integer id) {
		...
		try {
			Artists instance = (Artists) sessionFactory.getCurrentSession().get("com.jxust.svsh.dao.Artists", id);
			if (instance == null) {
	...
	public List<Artists> findByExample(Artists instance) {
		...
		try {
			List<Artists> results = (List<Artists>) sessionFactory.getCurrentSession()
					.createCriteria("com.jxust.svsh.dao.Artists").add(create(instance)).list();
