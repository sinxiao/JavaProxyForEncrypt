...
import com.jxust.svsh.entity.Information;

/**
 * Home object for domain model class Information.
 * @see com.jxust.svsh.dao.Information
 * @author Hibernate Tools
 */
public class InformationHome {

	private static final Log log = LogFactory.getLog(InformationHome.class);
	...
	public void persist(Information transientInstance) {
	...
	public Information merge(Information detachedInstance) {
		...
		try {
			Information result = (Information) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Information findById(java.lang.Integer id) {
		...
		try {
			Information instance = (Information) sessionFactory.getCurrentSession()
					.get("com.jxust.svsh.dao.Information", id);
			if (instance == null) {
	...
	public List<Information> findByExample(Information instance) {
		...
		try {
			List<Information> results = (List<Information>) sessionFactory.getCurrentSession()
					.createCriteria("com.jxust.svsh.dao.Information").add(create(instance)).list();
