...
import com.jxust.svsh.entity.Item;

/**
 * Home object for domain model class Item.
 * @see com.jxust.svsh.dao.Item
...
public class ItemHome {
	...
	public Item findById(java.lang.Integer id) {
		...
		try {
			Item instance = (Item) sessionFactory.getCurrentSession().get("com.jxust.svsh.dao.Item", id);
			if (instance == null) {
	...
	public List<Item> findByExample(Item instance) {
		...
		try {
			List<Item> results = (List<Item>) sessionFactory.getCurrentSession()
					.createCriteria("com.jxust.svsh.dao.Item").add(create(instance)).list();
