...
import com.jxust.svsh.entity.Locations;

/**
 * Home object for domain model class Locations.
 * @see com.jxust.svsh.dao.Locations
...
public class LocationsHome {
	...
	public Locations findById(java.lang.Integer id) {
		...
		try {
			Locations instance = (Locations) sessionFactory.getCurrentSession().get("com.jxust.svsh.dao.Locations", id);
			if (instance == null) {
	...
	public List<Locations> findByExample(Locations instance) {
		...
		try {
			List<Locations> results = (List<Locations>) sessionFactory.getCurrentSession()
					.createCriteria("com.jxust.svsh.dao.Locations").add(create(instance)).list();
