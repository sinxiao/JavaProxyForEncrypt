...
import com.jxust.svsh.entity.Organization;

/**
 * Home object for domain model class Organization.
 * @see com.jxust.svsh.dao.Organization
	...
	public Organization findById(java.lang.Integer id) {
		...
		try {
			Organization instance = (Organization) sessionFactory.getCurrentSession()
					.get("com.jxust.svsh.dao.Organization", id);
			if (instance == null) {
	...
	public List<Organization> findByExample(Organization instance) {
		...
		try {
			List<Organization> results = (List<Organization>) sessionFactory.getCurrentSession()
					.createCriteria("com.jxust.svsh.dao.Organization").add(create(instance)).list();
