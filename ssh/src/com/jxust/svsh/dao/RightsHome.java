...
import com.jxust.svsh.entity.Rights;

/**
 * Home object for domain model class Rights.
 * @see com.jxust.svsh.dao.Rights
...
public class RightsHome {
	...
	public Rights merge(Rights detachedInstance) {
		...
		try {
			Rights result = (Rights) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Rights findById(java.lang.Integer id) {
		...
		try {
			Rights instance = (Rights) sessionFactory.getCurrentSession().get("com.jxust.svsh.dao.Rights", id);
			if (instance == null) {
	...
	public List<Rights> findByExample(Rights instance) {
		...
		try {
			List<Rights> results = (List<Rights>) sessionFactory.getCurrentSession()
					.createCriteria("com.jxust.svsh.dao.Rights").add(create(instance)).list();
