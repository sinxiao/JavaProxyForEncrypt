...
import com.jxust.svsh.entity.Tags;

/**
 * Home object for domain model class Tags.
 * @see com.jxust.svsh.dao.Tags
...
public class TagsHome {
	...
	public Tags merge(Tags detachedInstance) {
		...
		try {
			Tags result = (Tags) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Tags findById(java.lang.Integer id) {
		...
		try {
			Tags instance = (Tags) sessionFactory.getCurrentSession().get("com.jxust.svsh.dao.Tags", id);
			if (instance == null) {
	...
	public List<Tags> findByExample(Tags instance) {
		...
		try {
			List<Tags> results = (List<Tags>) sessionFactory.getCurrentSession()
					.createCriteria("com.jxust.svsh.dao.Tags").add(create(instance)).list();
