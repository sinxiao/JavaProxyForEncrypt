...
import com.jxust.svsh.entity.Template;

/**
 * Home object for domain model class Template.
 * @see com.jxust.svsh.dao.Template
...
public class TemplateHome {
	...
	public Template merge(Template detachedInstance) {
		...
		try {
			Template result = (Template) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Template findById(java.lang.Integer id) {
		...
		try {
			Template instance = (Template) sessionFactory.getCurrentSession().get("com.jxust.svsh.dao.Template", id);
			if (instance == null) {
	...
	public List<Template> findByExample(Template instance) {
		...
		try {
			List<Template> results = (List<Template>) sessionFactory.getCurrentSession()
					.createCriteria("com.jxust.svsh.dao.Template").add(create(instance)).list();
